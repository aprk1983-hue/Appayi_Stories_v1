...
class _StoryPlayerScreenState extends State<StoryPlayerScreen> with RouteAware {
  ...
  // Subscription has been removed: all stories/features are unlocked.
  // Keep a constant flag to minimize changes across the player.
  final bool _isSubscribedUser = true;
  @override
  void initState() {
    super.initState();
  ...
  Future<bool> _tryLoadSingleAttempt() async {
    try {
      ...
      if (!alreadyLoaded) {
        // Auto-play (quiet hours are still respected via Parental Controls).
