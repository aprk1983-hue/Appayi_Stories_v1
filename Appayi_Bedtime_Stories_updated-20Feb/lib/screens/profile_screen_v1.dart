...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadData() async {
    await Future.wait([_loadUser(), _loadDeviceModel()]);
  ...
  void _openContact() {
    _pushSmooth(const _ContactUsPage(supportEmail: 'support@lalastories.app'));
  }
...
class _ProfileNavTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final ac = accentColor ?? const Color(0xFF1A73E8);
