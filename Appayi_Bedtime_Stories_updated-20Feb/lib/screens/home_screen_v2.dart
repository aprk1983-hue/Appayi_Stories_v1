...
//       setState(() {
//         _isSubscribedUser = v;
//         debugPrint('🔄 HomeScreen: Subscription status updated to: $v');
//       });
//     });
//     // _subStatusSub =
//     //     SubscriptionAccessService.instance.watchIsSubscribed().listen((v) {
...
//       // },
//       onTap: () async {
//         // Check if user is subscribed using the NEW service
//         final isSubscribed =
...
//       future: SubscriptionAccessService.instance
//           .getFreeShareIdsForLanguage(langCode),
//       builder: (context, snap) {
...
//                         ),
//                       ),
//                       const _BlinkingFreeBadge(text: '10 free'),
//                     ],
//                   ),
//                 ),
//                 const SizedBox(
...
//             .collection('stories')
//             .where('shareId', whereIn: limitedIds);

//         List<Story> _toStories(
...
//                 right: 16), // Start flush left, pad right only
...
//                 imageFit:
//                     BoxFit.cover, // Ensure image fills area for rounded edges
...
//                       ),
//                     ),
//                     _BlinkingFreeBadge(text: '${limitedIds.length} free'),
//                   ],
//                 ),
//               ),
//               SizedBox(
...
//     return InkWell(
//       onTap: () async {
//         // ✅ Check subscription using the NEW service
//         final isSubscribed =
//             await SubscriptionService().checkSubscriptionStatus();
...
//                     // If keeping, it should also check subscription
//                     GestureDetector(
//                       onTap: () async {
//                         final isSubscribed = await SubscriptionService()
