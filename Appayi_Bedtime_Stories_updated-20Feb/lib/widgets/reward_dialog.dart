...
Future<void> showRewardDialog(
  ...
  // UI-only change: auto-dismiss the reward dialog after 5 seconds
  // so the player can continue to the next story without requiring a tap.
  // showDialog() uses the root navigator by default; use the same one to pop.
