...
class _RewardsScreenState extends State<RewardsScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildBadgesGrid() {
    ...
    return GridView.builder(
      ...
      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
        ...
        crossAxisSpacing: 16,
        mainAxisSpacing: 16,
        childAspectRatio: 0.78, // gives room for label
      ),
  ...
  Widget _buildGemGrid() {
    final int collectedCount = _unlockedGemIds.length;
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                child: const Center(
                  child: Icon(Icons.diamond_rounded, color: Colors.orange, size: 28),
                ),
              );
            },
          ),
...
Color _badgeAccentColor(Badge badge) {
  // UI-only: stable "different color" per badge, based on its id.
  const palette = <Color>[
    Colors.deepPurple,
    Colors.indigo,
    Colors.blue,
  ...
  final hash = badge.id.codeUnits.fold<int>(0, (p, c) => p + c);
...
class _BadgeIcon extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final baseColor = _badgeAccentColor(badge);
    final color = isUnlocked ? baseColor : Colors.grey.withOpacity(0.25);
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: color,
                border: Border.all(color: color.withOpacity(0.45), width: 3),
              ),
